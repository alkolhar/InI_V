 ...
 * generated in the net.ensode.glassfishbook package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://glassfishbook.ensode.net/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://glassfishbook.ensode.net/", "addResponse");
    private final static QName _Div_QNAME = new QName("http://glassfishbook.ensode.net/", "div");
    private final static QName _DivResponse_QNAME = new QName("http://glassfishbook.ensode.net/", "divResponse");
    private final static QName _Mul_QNAME = new QName("http://glassfishbook.ensode.net/", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://glassfishbook.ensode.net/", "mulResponse");
    private final static QName _Sub_QNAME = new QName("http://glassfishbook.ensode.net/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://glassfishbook.ensode.net/", "subResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.ensode.glassfishbook
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://glassfishbook.ensode.net/", name = "add")
     ...
     */
    @XmlElementDecl(namespace = "http://glassfishbook.ensode.net/", name = "addResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://glassfishbook.ensode.net/", name = "div")
     ...
     */
    @XmlElementDecl(namespace = "http://glassfishbook.ensode.net/", name = "divResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://glassfishbook.ensode.net/", name = "mul")
     ...
     */
    @XmlElementDecl(namespace = "http://glassfishbook.ensode.net/", name = "mulResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://glassfishbook.ensode.net/", name = "sub")
     ...
     */
    @XmlElementDecl(namespace = "http://glassfishbook.ensode.net/", name = "subResponse")
