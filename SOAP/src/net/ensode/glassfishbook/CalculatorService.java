 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://glassfishbook.ensode.net/", wsdlLocation = "http://nbinf020:8080/SOAPWebService2/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://glassfishbook.ensode.net/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://nbinf020:8080/SOAPWebService2/CalculatorService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://glassfishbook.ensode.net/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://glassfishbook.ensode.net/", "CalculatorPort"), Calculator.class, features);
    }
